...
while(!0){if(i>a_len-1||j>b_len-1)break
...
this.tokenizerFn=fn
return this}
lunr.Index.prototype.add=function(doc,emitEvent){var docTokens={},allDocumentTokens=new lunr.SortedSet,docRef=doc[this._ref],emitEvent=emitEvent===undefined?!0:emitEvent
...
lunr.Index.prototype.remove=function(doc,emitEvent){var docRef=doc[this._ref],emitEvent=emitEvent===undefined?!0:emitEvent
if(!this.documentStore.has(docRef))return
var docTokens=this.documentStore.get(docRef)
this.documentStore.remove(docRef)
docTokens.forEach(function(token){this.tokenStore.remove(token,docRef)},this)
if(emitEvent)this.eventEmitter.emit('remove',doc,this)}
lunr.Index.prototype.update=function(doc,emitEvent){var emitEvent=emitEvent===undefined?!0:emitEvent
this.remove(doc,!1)
this.add(doc,!1)
...
lunr.TokenStore.prototype.has=function(token){if(!token)return!1
var node=this.root
for(var i=0;i<token.length;i++){if(!node[token.charAt(i)])return!1
